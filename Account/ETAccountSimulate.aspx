<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="ETAccountSimulate.aspx.vb" Inherits="Acc_ETSimulate" title="ET Account Simulate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
	<asp:Panel ID="pnlAccountNo" runat="server" DefaultButton="btnView" Width="100%" CssClass="AlternatingRowStyle">
...
function PrintData() {
	...
	if (Page_ClientValidate("")) {
	    var winref = window.open("../Reports/ReportView.aspx?Back=0&RPT=/DLEAS/ETAccountSimulate&VALUEDATE=" + VALUEDATE + "&LOCID=" + LOCID + "&ACCID=" + ACCID + "&OTHERFEE=" + OTHERFEE + "&ETCALCTYPE=" + ETCALC, "ETSimulate", "height=450,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes");
		winref.focus();
	}
	return false;
}
