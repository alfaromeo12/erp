...
Partial Class Param_Bank
    ...
    Private Sub SetValidation()
        ...
        oTextBox = CType(fvData.FindControl("txtBankCode"), TextBox)
    ...
    Private Sub DataSearch()
        If Not IsPostBack() Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND BANK.BANKID=-999"
        End If
    ...
    Protected Sub sdsForm_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles sdsForm.Inserted
        If e.Command.Parameters("@retval").Value = -1 Then
            ...
            lblError.Text = "Bank Code : " & e.Command.Parameters("@BankCode").Value & " already exists..!"
        Else
            lblError.Visible = False
            fvData.Caption = ""
        End If
