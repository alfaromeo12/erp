<%@ Page Language="VB" MasterPageFile="~/MXPageNoBusy.master" AutoEventWireup="false" CodeFile="AccForJFNew.aspx.vb" Inherits="Txn_AccForJFNew" title="Account For JF - NEW" EnableEventValidation="FALSE" %>
<%@ Register Src="../UserControl/NoDataFound.ascx" TagName="NoDataFound" TagPrefix="uc6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    <asp:ScriptManagerProxy ID="SMPJFNew" runat="server">
    <Services>
    ...
    <ajaxToolkit:TextBoxWatermarkExtender ID="ajxTBWESearch" runat="server" TargetControlID="txtSearch"
        WatermarkText="%%">
            ...
            <tr>
                ...
                <td class="FooterStyle">
                    <asp:CheckBox ID="cbPastDue" runat="server" 
                        Text="NO, Do not include past due" /></td>
                <td class="FooterStyle">
                    Currency</td>
                <td class="FooterStyle">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtDSR" runat="server" Width="40px" style="text-align: right"></asp:TextBox>%<asp:RequiredFieldValidator
                        ID="reqDSR" runat="server" ControlToValidate="txtDSR" Display="None" ErrorMessage="DSR must be entry...!"
                        SetFocusOnError="True"></asp:RequiredFieldValidator><ajaxToolkit:ValidatorCalloutExtender
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtAge" runat="server" Width="40px" style="text-align: right"></asp:TextBox>Year<asp:RequiredFieldValidator
                        ID="reqAGe" runat="server" ControlToValidate="txtAge" Display="None" ErrorMessage="AGE  must be entry...!"
                        SetFocusOnError="True"></asp:RequiredFieldValidator><ajaxToolkit:ValidatorCalloutExtender
                            ID="ajaxVCEAge" runat="server" HighlightCssClass="ErrHighLight" TargetControlID="reqAGe">
                        </ajaxToolkit:ValidatorCalloutExtender>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="sdsInstallmentTypeSearch" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:connection %>" 
                        SelectCommand="SELECT NULL AS CODE, '[ALL INS. TYPE]' AS NAME UNION ALL SELECT CODE, CODE + ' - ' + NAME AS NAME FROM PARAMGLOBAL WITH (NOLOCK) WHERE (TYPE = 'INSTALLMENTTYPE')">
                    </asp:SqlDataSource>
                </td>
                <td>
                    Product</td>
        ...
        <asp:UpdatePanel ID="UPGrid" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gvData" runat="server" AllowPaging="True" AllowSorting="True" 
                    AutoGenerateColumns="False" Caption="Account for JF - NEW ACCOUNT" 
                        ...
                        <asp:TemplateField HeaderText="Days&lt;br&gt;To&lt;br&gt;Due" 
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDayDiff" runat="server" 
                                    BackColor='<%# System.Drawing.Color.FromName(DataBinder.Eval(Container.DataItem,"DAYDIFFCOLOR").ToString()) %>' 
                                    Font-Bold="True" Font-Underline="True" Text='<%# Bind("DAYDIFF") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="sdsGrid" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:connection %>" 
                    SelectCommand="SELECT TOP (1000) LOCID, APPID, REQUESTDATE, ACCOUNTNAME, BRANCH, ACCID, IDNUMBER, BOOKINGDATE, REFNO, ACCNO, CUSTNO, DSR, OSPRINCIPAL, OSINTEREST, OSTENOR, NEXTDUEDATE, DAYDIFF, DAYDIFFCOLOR FROM v_AccountForJFNew WHERE (ACCSTATUS = 1) AND (OSTENOR &gt; 0) AND (OSPRINCIPAL &gt; 0)">
                </asp:SqlDataSource>
                <asp:CheckBox ID="chkAll" runat="server" Text="Check/UnCheck All" />
            </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <br />
    <br />
    <asp:Panel ID="pnlProcess" runat="server" CssClass="RowStyle" Font-Bold="True" GroupingText="JF REQUEST - NEW ACCOUNT"
        Width="100%">
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="4">
            ...
            <tr>
                ...
                <td>
                    Installment Day</td>
                <td>
                    <asp:TextBox ID="txtInstallmentDay" runat="server" Width="48px"></asp:TextBox>*)</td>
            </tr>
            <tr>
                <td>
                    Loan Type</td>
                ...
                <td>
                    Tenor</td>
                <td>
                    <asp:TextBox ID="txtTenor" runat="server" Style="text-align: right" Width="56px"></asp:TextBox>*)</td>
            </tr>
            <tr>
                <td>
                    Use Rate</td>
                <td>
                    <asp:RadioButton ID="rbJFRate" runat="server" GroupName="UseRate" Text="Join Finance Rate" />
                    <asp:RadioButton ID="rbCustRate" runat="server" GroupName="UseRate" Text="Customer Rate" /></td>
                <td>
                </td>
                <td>
                </td>
...
function OnCompleteJF(arg) {
    ...
    var oTenor=getObjectbyClientID("<%=txtTenor.ClientID%>")
    var oLT=getObjectbyClientID("<%=ddlLoanType.ClientID%>")
    if (arg=="1"){
        ...
        oTenor.value=""
        oTenor.readOnly=true;
        oTenor.className="disabled";
        oLT.value=""
        oLT.disabled=true;
        oLT.className="disabled";
