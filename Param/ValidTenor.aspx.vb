Partial Class Param_ValidTenor
    ...
    Private Sub SetValidation()
        ...
        oTextBox = CType(fvData.FindControl("TENORNAMETextBox"), TextBox)
        ...
        oTextBox = CType(fvData.FindControl("MINTENORNEWTextBox"), TextBox)
        If oTextBox IsNot Nothing Then SetObjectValidation(oTextBox, False, "", "[0-9.]")
        oTextBox = CType(fvData.FindControl("MAXTENORNEWTextBox"), TextBox)
        If oTextBox IsNot Nothing Then SetObjectValidation(oTextBox, False, "", "[0-9.]")
        oTextBox = CType(fvData.FindControl("MINTENORUSEDTextBox"), TextBox)
        If oTextBox IsNot Nothing Then SetObjectValidation(oTextBox, False, "", "[0-9.]")
        oTextBox = CType(fvData.FindControl("MAXTENORUSEDTextBox"), TextBox)
        If oTextBox IsNot Nothing Then SetObjectValidation(oTextBox, False, "", "[0-9.]")
