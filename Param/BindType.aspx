<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="BindType.aspx.vb" Inherits="Param_BindType" title="Parameter Binding Type (BI)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:Panel ID="pnlData" runat="server">
        <asp:GridView ID="gvData" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            DataKeyNames="BINDTYPEID" Caption="Binding Type List" 
            RowHeaderColumn="BINDTYPEID">
            <Columns>
                <asp:CommandField ButtonType="Image" SelectImageUrl="~/images/edit.gif" ShowSelectButton="True">
                    <ItemStyle Width="20px" HorizontalAlign="Center" />
                </asp:CommandField>
                <asp:BoundField DataField="BINDTYPEID" HeaderText="ID" ReadOnly="True" SortExpression="BINDTYPEID">
                </asp:BoundField>
                <asp:BoundField DataField="BTCODE" HeaderText="Code&lt;br&gt;(BI Code)" HtmlEncode="False"
                    SortExpression="BTCODE" />
                <asp:BoundField DataField="BTCODEBI" HeaderText="Bind Code&lt;br&gt;(BI Code)" 
                    HtmlEncode="False" SortExpression="BTCODEBI" />
    ...
    <asp:SqlDataSource ID="sdsGrid" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        ...
        SelectCommand="SELECT BINDTYPEID, BTCODE, BTCODEBI, BTNAME FROM BINDTYPE WHERE (DELETESTS = 0)"></asp:SqlDataSource>
    ...
    <asp:FormView ID="fvData" runat="server" DataSourceID="sdsForm"
        DefaultMode="Edit" Width="100%" DataKeyNames="BINDTYPEID">
        <EditItemTemplate>
            <table cellpadding=0 cellspacing=0 width="100%">
                ...
                <tr>
                    <td>
                        ID</td>
                    <td>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("BINDTYPEID") %>'></asp:Label></td>
                </tr>
                <tr>
                    <td>
                        Code (BI Code)</td>
                    <td>
                        <asp:TextBox ID="txtCode" runat="server" Width="56px" MaxLength="10" Text='<%# Bind("BTCODE") %>' CssClass="required"></asp:TextBox><asp:RequiredFieldValidator
                ...
                <tr>
                    <td>
                        Bind Code (BI Code)</td>
                    <td>
                        <asp:TextBox ID="txtCodeBI" runat="server" Text='<%# Bind("BTCODEBI") %>' CssClass="required"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        Name</td>
                    <td>
                        <asp:TextBox ID="txtName" runat="server" Width="371px" MaxLength="100" Text='<%# Bind("BTNAME") %>' CssClass="required"></asp:TextBox><asp:RequiredFieldValidator
            ...
            <table cellpadding=0 cellspacing=0 width="100%">
                ...
                <tr>
                    <td>
                        Bind&nbsp; Code</td>
                    <td>
                        <asp:TextBox ID="txtCode" runat="server" MaxLength="10" Text='<%# Bind("BTCODE") %>'
                ...
                <tr>
                    <td>
                        Name</td>
                    <td>
                        <asp:TextBox ID="txtName" runat="server" MaxLength="100" Text='<%# Bind("BTNAME") %>'
    ...
    <asp:SqlDataSource ID="sdsForm" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        ...
        SelectCommand="SELECT BINDTYPEID, BTCODE, BTCODEBI, BTNAME FROM BINDTYPE WHERE (BINDTYPEID = @BINDTYPEID)" 
        DeleteCommand="UPDATE BINDTYPE SET DELETESTS = 1, LASTUSERID = @UserID, LASTUPDATE = GETDATE() WHERE (BINDTYPEID = @BINDTYPEID)" 
        UpdateCommand="BINDTYPEUpdate" InsertCommand="BINDTYPEAdd" 
        InsertCommandType="StoredProcedure" UpdateCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter ControlID="gvData" Name="BINDTYPEID" PropertyName="SelectedValue" />
        </SelectParameters>
        <DeleteParameters>
            <asp:CookieParameter CookieName="UID" Name="UserID" />
            <asp:Parameter Name="BINDTYPEID" />
        </DeleteParameters>
        <UpdateParameters>
            <asp:Parameter Name="BINDTYPEID" Type="Int32" />
