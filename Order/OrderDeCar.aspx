<%@ Page Title="" Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="OrderDeCar.aspx.vb" Inherits="Transportasi_Transportasi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsGrid" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        SelectCommand=" SELECT OC.ORDERID,OC.ORDERCODE,CUSTOMERID,AUC.FULLNAME AS CUSTOMERNAME,MITRAID,AUP.FULLNAME AS MITRANAME,AUP.NUMBERPLATE,ISNULL(CO.CANCELORDERNAME,'-') AS CANCELORDERNAME
    ...
    <asp:SqlDataSource ID="sdsMitra" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>" SelectCommand=" SELECT NULL AS USERID, '[DISPLAY ALL]' AS FULLNAME UNION ALL 
                                                                                                                           SELECT USERID, FULLNAME FROM APPUSERPARTNER WHERE  SERVICETYPEDTLID = 3 AND ACTIVE= 1 AND (DELETESTS= 0) ORDER BY FULLNAME"></asp:SqlDataSource>
