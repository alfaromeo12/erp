<%@ Page Title="" Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="WaiveOverDueApproval.aspx.vb" Inherits="Account_WaiveOverDueApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
	...
	<asp:Panel ID="pnlPayment" runat="server" Width="100%">
		...
		<asp:Panel ID="pnlLoanData" runat="server" Width="100%">
			<uc3:LoanDataFromParamAccID ID="LoanDataFromParamAccID" runat="server" />
		</asp:Panel>
         ...
         <asp:Panel ID="pnlNonSPV" runat="server" Width="99%">
		    ...
		    <tr>
		        ...
		        <tr>
                    ...
                    <td ID="WaiveInstDue" class="RowStyle">
			...
			<tr id="WaiveSPV">
                <td class="FooterStyle">
                    Total Waive</td>
                <td class="FooterStyle">
                    <asp:TextBox ID="txtWaiveTotal" runat="server" CssClass="disabled" 
...
<asp:Panel ID="pnlControl" runat="server" CssClass="HeaderStyle" Style="border-right: thin inset;
  ...
  <asp:Label ID="lblMessage" runat="server" CssClass="ErrHighLight" 
     ...
     <asp:Button ID="btnApproval" runat="server" OnClientClick="return ProcessAPP();" 
        Style="background-position: right; background-image: url(../Images/approve.gif); cursor: pointer; background-repeat: no-repeat; text-align: left; " 
        Text="Approval" Width="88px" />
    <asp:Button ID="btnReject" runat="server" CausesValidation="False" 
        ...
        Text="Reject" Width="88px" ToolTip="Reject " />
    <asp:Button ID="btnCancel" runat="server" CausesValidation="False" 
        ...
        Text="Cancel" ToolTip="Cancel" Width="88px" />
...
<script type="text/javascript">
    ...
    function load() {
        ...
        if (sAction == "INPSPV" || sAction=="APPSPV") {
        ...
        } else if (sAction == "INP" || sAction == "APP") {
    ...
    function CalcETWaive() {
        ...
        oInstallmentWaive.value = FormatNumber(InstallmentDue - PrincipalWaive - InterestWaive - PenaltyWaive, 'True', 0);
