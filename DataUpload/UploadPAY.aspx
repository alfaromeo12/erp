<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="UploadPAY.aspx.vb" Inherits="DataUpload_UploadPAY" title="PAYMENT UPLOAD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                <asp:Panel ID="pnlPayment" runat="server" Width="100%" GroupingText="FILE PAYMENT" CssClass="FooterStyle" Font-Bold="True">
                <asp:FileUpload ID="FileBranch" runat="server" CssClass="required" Width="100%" 
                        Font-Size="Medium" size="75" />
                <asp:Label ID="lblMessagePay" runat="server" CssClass="ErrHighLight" Visible="False"></asp:Label></asp:Panel>
            </td>
        </tr>
        <tr>
            <td>
    ...
    function ShowAlert(){
        alert("UPLOAD PAYMENT File ERROR...! Please see the error detail..!");
    }
    </script>
    <%=strScript%>
