<%@ Page Language="VB" MasterPageFile="~/MXPageNoBusy.master" AutoEventWireup="false" CodeFile="AccJFInqList.aspx.vb" Inherits="Txn_AccJFInq" title="Account JF Inquiry List" EnableEventValidation="FALSE" %>
        ...
        WatermarkText="%%">
            ...
            <tr>
                <td>
                    Bank Name</td>
                <td>
                    <asp:DropDownList ID="ddlBankSearch" runat="server" DataSourceID="sdsBank" 
            ...
            <tr>
                ...
                <td>
                    ...
                    <ajaxToolkit:CascadingDropDown ID="ajaxCDDJF" runat="server" Category="JF" 
                        LoadingText="[Loading JF/Bank...]" ParentControlID="ddlJFGroup" 
                        PromptText="[DISPLAY ALL]" ServiceMethod="GetDropDownJFByJFGroup" 
                        ServicePath="~\Param\WebService.asmx" TargetControlID="ddlJF">
                    </ajaxToolkit:CascadingDropDown>
                </td>
            </tr>
        </table>
        ...
        <asp:UpdatePanel ID="UPGrid" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gvData" runat="server" AllowPaging="True" AllowSorting="True" 
                    AutoGenerateColumns="False" Caption="Account Join Finance (Bank) List" 
