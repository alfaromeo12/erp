<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="AccDisbBatchAppDealer.aspx.vb" Inherits="Txn_DisbBatchAppDealer" title="Disbursement Approval per Dealer" EnableEventValidation="FALSE" MaintainScrollPositionOnPostback="true"%>
            ...
            <tr ID="trBank">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="reqDealerBank" runat="server" 
                        ...
                        ErrorMessage="DEALER BANK ACCOUNT must be entry...!" 
                        SetFocusOnError="True" ValidationGroup="ValApp"></asp:RequiredFieldValidator>
                    <ajaxToolkit:ValidatorCalloutExtender ID="reqDealerBank_ValidatorCalloutExtender" 
...
function PrintData() {
    ...
    if (Page_ClientValidate("")) {
        var winref = window.open("../Reports/ReportView.aspx?Back=0&RPT=/DLEAS/Disbursement_ApprovalPerDealer&DEALERID=" + DEALERID + "&PLANPAIDFROM=" + PAIDFROM + "&PLANPAIDTO=" + PAIDTO, "DisbursementApprovalPerDealer", "height=450,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes");
        winref.focus();
    }
    return false;
}
