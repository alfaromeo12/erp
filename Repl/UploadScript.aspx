<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="UploadScript.aspx.vb" Inherits="Repl_UploadZipScript" title="Upload Zip File - Script" aspcompat="true"%>
...
function ShowAlert(){
    alert("UPLOAD SCRIPT ERROR...! Please see the error detail..!");
}
</script>
