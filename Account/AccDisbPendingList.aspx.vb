...
Partial Class Txn_AccDisbursePending
    ...
    Private Sub DataSearch()
        ...
        If txtAction.Value = "INIT" Then
            lblStatus.Visible = False
            ddlStatusSearch.Visible = False
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNTDTL.PENDINGSTS=0 AND ACCOUNTDTL.PENDINGDISBURSE>0"
        ElseIf txtAction.Value = "APP" Then
            lblStatus.Visible = False
            ddlStatusSearch.Visible = False
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNTDTL.PENDINGSTS=1 AND ACCOUNTDTL.PENDINGDISBURSE>0"
        Else
            lblStatus.Visible = True
            ddlStatusSearch.Visible = True
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNTDTL.PENDINGDISBURSE>0"
        End If
        ...
        If rbTxnDate.Checked Then
            If Len(Trim(txtTxnFrom.Text)) > 0 And Len(Trim(txtTxnFrom.Text)) > 0 Then
                Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND (ACCOUNTDTL.PENDINGPAIDDATE BETWEEN CONVERT(DATETIME, '" + txtTxnFrom.Text + "', 103) AND CONVERT(DATETIME, '" + txtTxnTo.Text + "', 103))"
            Else
                Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND (ACCOUNTDTL.PENDINGPAIDDATE BETWEEN CONVERT(DATETIME, '" + txtAppDate.Value + "', 103) AND CONVERT(DATETIME, '" + txtAppDate.Value + "', 103))"
            End If
        End If
        ...
        If Len(Trim(ddlStatusSearch.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNTDTL.PENDINGSTS=" & ddlStatusSearch.SelectedValue
        End If

        If Len(Trim(ddlDisbStatus.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNT.DISBURSESTS=" & ddlDisbStatus.SelectedValue
        End If
    ...
    Protected Sub gvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvData.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            If DataBinder.Eval(e.Row.DataItem, "PENDINGSTS") = 0 Then
                e.Row.ForeColor = Drawing.Color.Red
            ElseIf DataBinder.Eval(e.Row.DataItem, "PENDINGSTS") = 1 Then
    ...
    Protected Sub btnSave_Click(sender As Object, e As System.EventArgs) Handles btnSave.Click
                ...
                If oCheckBox IsNot Nothing Then
                    If oCheckBox.Checked Then
                        ...
                        intRetVal = objDB.ExecSPReturnInteger("ACCOUNTDTLPendingDisburseApprove",
                            ...
                            objDB.MP("@ACCID", Data.SqlDbType.BigInt, strACCID),
        ...
        Catch ex As Exception
            ...
            lblMessage.Text = "ERROR SAVE PENDING DISBURSEMENT...!<BR>PLEASE CHECK DETAIL ERROR MESSAGE : <BR>" & ex.Message
        Finally
            objDB.Close()
            objDB = Nothing
        End Try
    ...
    Protected Sub btnApprove_Click(sender As Object, e As System.EventArgs) Handles btnApprove.Click
        ...
        Catch ex As Exception
            lblMessage.Visible = True
            lblMessage.Text = "ERROR APPROVE (PAID) PENDING DISBURSEMENT...!<BR>PLEASE CHECK DETAIL ERROR MESSAGE : <BR>" & ex.Message
            lblMessage.Focus()
        Finally
            objDB.Close()
            objDB = Nothing
