<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="AccNPLReasonEntry.aspx.vb" Inherits="Account_AccNPLEntry" title="Account NPL Reason Entry" MaintainScrollPositionOnPostback="true"%>
        ...
        <tr>
            ...
            <td class="AlternatingRowStyle" colspan="3">
                <asp:DropDownList ID="ddlNPLReason" runat="server" DataSourceID="sdsNPLReason" DataTextField="NPLREASONNAME"
                    ...
                    SelectCommand="SELECT NULL AS NPLREASONID, NULL AS NPLREASONCODE, '[NPL REASON]' AS NPLREASONNAME UNION ALL SELECT NPLREASONID, NPLREASONCODE, NPLREASONCODE + ' - ' + NPLREASONNAME AS Expr1 FROM NPLREASON WITH (NOLOCK) WHERE (DELETESTS = 0) ORDER BY NPLREASONCODE">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            ...
            <td class="AlternatingRowStyle" colspan="3">
                <asp:TextBox ID="txtReasonDesc" runat="server" Height="54px" TextMode="MultiLine"
