...
Partial Class Param_ValidDP
    ...
    Private Sub SetValidation()
        ...
        oTextBox = CType(fvData.FindControl("DPNAMETextBox"), TextBox)
        ...
        oTextBox = CType(fvData.FindControl("MINDPNEWTextBox"), TextBox)
        If oTextBox IsNot Nothing Then SetObjectValidation(oTextBox, False, "", "[0-9.]")
        oTextBox = CType(fvData.FindControl("MINDPUSEDTextBox"), TextBox)
        If oTextBox IsNot Nothing Then SetObjectValidation(oTextBox, False, "", "[0-9.]")
