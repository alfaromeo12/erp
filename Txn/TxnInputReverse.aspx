<%@ Page Title="Txn - General Transaction Reverse" Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="TxnInputReverse.aspx.vb" Inherits="Txn_TxnInputReverse" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
               ...
               <asp:GridView ID="gvJournal" runat="server" AutoGenerateColumns="False" DataSourceID="sdsGridJournal"
                ...
                <asp:Panel ID="pnlControl" runat="server" CssClass="HeaderStyle" Style="border-right: thin inset;
                 ...
                 <Animations>
                    ...
                    <asp:Button ID="btnReverse" runat="server" CommandName="Reverse" 
                        Style="background-position: left; background-image: url(../images/return.png); cursor: pointer; background-repeat: no-repeat; text-align: right; " 
                        Text="Reverse" ToolTip="Reverse Transaction" Width="72px" />
