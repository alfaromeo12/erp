<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="DealerApp.aspx.vb" Inherits="Param_DealerApp" title="DealerApp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:DropDownList ID="ddlCriteria" runat="server">
        ...
        <asp:GridView ID="gvData" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            Width="100%" Caption="Dealer List for Approval" 
            RowHeaderColumn="DEALERID">
            <Columns>
                ...
                <asp:BoundField DataField="CITYID" HeaderText="City&lt;br&gt;ID" 
                    SortExpression="CITYID" HtmlEncode="False" />
    ...
    <asp:SqlDataSource ID="sdsGrid" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        ...
        SelectCommand="SELECT DEALERX.DEALERID, DEALERX.DEALERCODE, DEALERX.DEALERNAME, DEALERX.BRANCHID, BRANCH.BRANCHCODE, BRANCH.BRANCHNAME, DEALERX.ADDRESS, DEALERX.CITYID, DEALERX.PROVINCE, DEALERX.HEADDEALER, '(' + DEALERX.PHONEAREA + ') ' + DEALERX.PHONE AS PHONE FROM DEALERX LEFT OUTER JOIN BRANCH WITH (NOLOCK) ON DEALERX.BRANCHID = BRANCH.BRANCHID WHERE (DEALERX.Deletests = 0)"></asp:SqlDataSource>
    ...
    <asp:FormView ID="fvData" runat="server" DataSourceID="sdsForm"
        ...
        <EditItemTemplate>
        <asp:Panel ID="pnlDealer" runat="server" Enabled="False">
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="2">
                        <hr />
                ...
                <tr>
                    <td>
                        ID</td>
                    <td>
                        <asp:Label ID="lblDealerID0" runat="server" Text='<%# Eval("DEALERID") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <ajaxToolkit:ValidatorCalloutExtender ID="reqDealerCode_ValidatorCalloutExtender" 
                            runat="server" HighlightCssClass="ErrHighLight" TargetControlID="reqDealerCode">
                ...
                <tr>
                    <td>
                        Dealer Name</td>
                    <td>
                        <asp:TextBox ID="txtDealerName" runat="server" CssClass="required" 
                            MaxLength="50" Text='<%# Bind("DEALERNAME") %>' Width="240px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reqDealerName" runat="server" 
                            ControlToValidate="txtDealerName" Display="None" 
                            ErrorMessage="Dealer Name must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        <ajaxToolkit:ValidatorCalloutExtender ID="reqDealerName_ValidatorCalloutExtender" 
                            runat="server" HighlightCssClass="ErrHighLight" TargetControlID="reqDealerName">
                        </ajaxToolkit:ValidatorCalloutExtender>
                        &nbsp;</td>
                </tr>
                <tr>
                    <td>
                        Dealer Alias</td>
                    <td>
                        <asp:TextBox ID="txtDealerAlias" runat="server" MaxLength="50" 
                            Text='<%# Bind("DEALERALIAS") %>' Width="240px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        Officer</td>
                    <td>
                        <asp:DropDownList ID="ddlMOID" runat="server" DataSourceID="sdsAO" 
                            DataTextField="AONAME" DataValueField="MOID" 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RadioButton ID="rbHasWorkshop_no" runat="server" 
                            Checked='<%# IIF(Eval("HASWORKSHOP"), false, true) %>' 
                            GroupName="rbHasWorkshop" Text="No" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <ajaxToolkit:CalendarExtender ID="txtDateStart_CalendarExtender" runat="server" 
                        ...
                        <asp:Image ID="imgDateStart0" runat="server" ImageUrl="~/images/grid.gif" 
                ...
                <tr>
                    <td>
                        Address</td>
                    <td>
                        <asp:TextBox ID="txtAddress" runat="server" CssClass="required" Height="40px" 
                            Text='<%# Bind("ADDRESS") %>' TextMode="MultiLine" Width="280px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtZip" runat="server" MaxLength="10" 
                            Text='<%# Bind("ZIP") %>' Width="64px"></asp:TextBox>
                        &nbsp;Province
                ...
                <tr>
                    <td>
                        Phone1</td>
                    <td>
                        <asp:TextBox ID="txtPhoneArea" runat="server" CssClass="required" MaxLength="4" 
                            Text='<%# Bind("PHONEAREA") %>' Width="50px"></asp:TextBox>
                        <asp:TextBox ID="txtPhone" runat="server" CssClass="required" MaxLength="15" 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        MaxLength="2" Text='<%# Bind("DAYSTODISBURSE") %>' Width="75px"></asp:TextBox>
    ...
    <asp:SqlDataSource ID="sdsDealer" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        SelectCommand="SELECT NULL AS DEALERMAINID, NULL AS DEALERMAINCODE, '[SELECT DEALER NAME]' AS DEALERMAINNAME
UNION ALL
SELECT DEALERMAINID,DEALERMAINCODE,'(' + DEALERMAINCODE + ') ' + DEALERMAINNAME AS DEALERMAINNAME 
FROM DEALERMAIN WHERE Deletests=0">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsAO" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        SelectCommand="SELECT NULL AS MOID, NULL AS AOCODE, '[SELECT ACCOUNT OFFICER]' AS AONAME
UNION ALL
SELECT AOID,AOCODE,'('+ AOCODE + ') '+ AONAME AS AONAME 
FROM AO WHERE DELETESTS=0">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsBranch" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        SelectCommand="SELECT NULL AS BRANCHID, NULL AS BRANCHCODE,'[SELECT BRANCH]' AS BRANCHNAME
UNION ALL
SELECT BRANCHID,BRANCHCODE,'(' + BRANCHCODE + ') ' + BRANCHNAME AS BRANCHNAME
FROM BRANCH WHERE Deletests=0">
    </asp:SqlDataSource>
...
<asp:SqlDataSource ID="sdsParamGlobal_ATPM" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
                            SelectCommand="SELECT NULL AS CODE, '[SELECT ATPM]'  AS NAME
UNION ALL
SELECT CODE, '(' + CODE + ') ' + NAME AS NAME
FROM PARAMGLOBAL WHERE TYPE='ATPM'">
                        </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsCorporate" runat="server" 
        ConnectionString="<%$ ConnectionStrings:connection %>" 
        SelectCommand="SELECT NULL AS COTYPEID, '[SELECT CORPORATE]' AS CONAME
UNION ALL
SELECT COTYPEID, '(' + CAST(COTYPEID AS VARCHAR) + ') ' + CONAME AS CONAME
FROM CORPORATETYPE WHERE DELETESTS=0">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsparamGL_placests" runat="server" 
        
        SelectCommand="SELECT NULL AS CODE, '[SELECT STATUS PLACE]'  AS NAME
UNION ALL
SELECT CODE, '(' + CODE + ') ' + NAME AS NAME
FROM PARAMGLOBAL WHERE TYPE='PLACESTS'
" 
        ConnectionString="<%$ ConnectionStrings:connection %>">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsparamGL_condition" runat="server" 
        
        SelectCommand="SELECT NULL AS CODE, '[SELECT CONDITION]' AS NAME
UNION ALL
SELECT CODE,'(' + CODE + ') ' + NAME AS NAME
FROM PARAMGLOBAL WHERE TYPE='CONDITION'" 
        ConnectionString="<%$ ConnectionStrings:connection %>">
    </asp:SqlDataSource>
    &nbsp; &nbsp; &nbsp;&nbsp;
