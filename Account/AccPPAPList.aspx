<%@ Page Language="VB" MasterPageFile="~/MXPageNoBusy.master" AutoEventWireup="false" CodeFile="AccPPAPList.aspx.vb" Inherits="Txn_AccPPAP" title="Account PPAP Entry List" EnableEventValidation="FALSE"  MaintainScrollPositionOnPostback="true"%>
        ...
        WatermarkText="%%">
            ...
            <tr>
                ...
                <td style="width: 112px">
                    PPAP Entry</td>
                <td>
                    <asp:DropDownList ID="ddlPPAPEntry" runat="server" CssClass=" ">
        ...
        <asp:UpdatePanel ID="UPGrid" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gvData" runat="server" AllowPaging="True" AllowSorting="True" 
                    AutoGenerateColumns="False" Caption="Account List for PPAP Entry" 
...
function EditApp(LOCID, APPID){
    window.location="AccPPAPEntry.aspx?Action=" + GetValueTxtByClientID("<%=txtAction.ClientID%>") + "&LOCID=" + LOCID + "&APPID=" + APPID
}
