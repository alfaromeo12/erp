Partial Class Param_Holidays
    ...
    Private Sub SetValidation()
        ...
        oTextBox = CType(fvData.FindControl("txtHolidayDate"), TextBox)
    ...
    Protected Sub fvData_ItemCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewCommandEventArgs) Handles fvData.ItemCommand
        ...
        ElseIf e.CommandName = "Approve" Or e.CommandName = "Reject" Then
            ...
            Try
                ...
                intRetVal = objDB.ExecSPReturnInteger("HOLIDAYSAPPROVAL", _
                    objDB.MP("@HOLIDAYDATE", Data.SqlDbType.VarChar, fvData.DataKey.Item(0)), _
            ...
            Catch ex As Exception
                lblError.Visible = True
                lblError.Text = "HOLIDAY Reject/Approval Error: " & ex.Message & "<br>PLEASE CHECK DETAIL ERROR MESSAGE...!"
            Finally
                objDB.Close()
                objDB = Nothing
            End Try
