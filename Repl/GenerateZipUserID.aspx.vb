...
Partial Class Repl_GenerateZipbyUserID
    ...
    Protected Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        Try
            ...
            If oSDR.Read Then
                ...
                strWhere = "UID=" & ddlUserID.SelectedValue
                ...
                strNewFileName = Replace(strTextFileName, ".txt", "_" & ddlUserID.Text & ".txt")
                SFileNameZip = Replace(sFileName, ".txt", "_" & ddlUserID.Text & ".txt")
