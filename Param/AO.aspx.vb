...
Partial Class Param_AO
    ...
    Private Sub SetValidation()
        ...
        oTextBox = CType(fvData.FindControl("txtAOCode"), TextBox)
        If oTextBox IsNot Nothing Then
            SetObjectValidation(oTextBox, False, "uppercase nospace")
            oTextBox.Focus()
        End If
        'oTextBox = CType(fvData.FindControl("txtAOName"), TextBox)
    ...
    Protected Sub sdsForm_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles sdsForm.Inserted
        If e.Command.Parameters("@retval").Value = -1 Then
            ...
            lblError.Text = "AO Code : " & e.Command.Parameters("@AOCode").Value & " already exists..!"
        Else
            lblError.Visible = False
            fvData.Caption = ""
        End If
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlBranchSearch.SelectedIndexChanged
        DataSearch()
    End Sub
