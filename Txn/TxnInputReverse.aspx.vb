...
Partial Class Txn_TxnInputReverse
    ...
    Protected Sub btnReverse_Click(sender As Object, e As System.EventArgs) Handles btnReverse.Click
        lblMessage.Visible = False
        Dim objDB As New DBX
        Dim intRetVal As Integer
        Dim oSQLParam As System.Data.SqlClient.SqlParameterCollection
        Try
            oSQLParam = objDB.ExecSPReturnParam("TXNReverse", _
            ...
            If intRetVal = -1 Then
                ...
                lblMessage.Text = "DATA TRANSACTION ALREADY REVERSED..!<BR>PLEASE CHECK TRANSACTION IN GENERAL TRANSACTION INQUIRY..!"
            Else
