...
Partial Class PartnerLastLoc
    ...
    '    oTextBox = CType(fvData.FindControl("txtMasterUnitCode"), TextBox)
    ...
    Private Sub DataSearch()
        'If Not IsPostBack() Then
        '    Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND MASTERUNIT.MASTERUNITID=-999"
        'End If
    ...
    '        lblError.Text = "Unit Code : " & e.Command.Parameters("@MASTERUNITCODE").Value & " already exists..!"
    '    Else
    '        lblError.Visible = False
    '        fvData.Caption = ""
    '    End If
