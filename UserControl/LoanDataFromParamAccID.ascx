<%@ Control Language="VB" AutoEventWireup="false" CodeFile="LoanDataFromParamAccID.ascx.vb" Inherits="UserControl_LoanDataFromParamAccID" %>
	    <style type="text/css">
            .style1
            {
                font-weight: bold;
                    ...
                    <tr>
                        ...
                        <td style="margin-left: 120px" class="ErrHighLight">
                            (<asp:Label ID="Label20" runat="server" Font-Underline="True" 
                                Text='<%# Eval("INSTALLMENTTYPE") %>' CssClass="style1"></asp:Label>)
                            <asp:Label ID="Label47" runat="server" Font-Underline="True" 
                                Text='<%# Eval("INSTALLMENTTYPENAME") %>' CssClass="style1"></asp:Label>
                        </td>
                        <td class="ShowDetail">
                            Financing Category</td>
                        <td class="ErrHighLight">
                            (<asp:Label ID="Label48" runat="server" Font-Underline="True" 
                                Text='<%# Eval("FINCATCODE") %>' CssClass="style1"></asp:Label>)
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label23" runat="server" Font-Underline="True" 
                                Text='<%# Eval("INSTALLMENTSTART", "{0:dd/MM/yyyy}") %>' CssClass="style1"></asp:Label>
                        </td>
                        <td>
                            Installment End</td>
                        <td>
                            <asp:Label ID="Label25" runat="server" Font-Underline="True" 
                                Text='<%# Eval("INSTALLMENTEND", "{0:dd/MM/yyyy}") %>' CssClass="style1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td >
                        ...
                        <td >
                            <asp:Label ID="Label26" runat="server" Font-Underline="True" 
                                Text='<%# Eval("NEXTDUEDATE", "{0:dd/MM/yyyy}") %>' 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label33" runat="server" Font-Underline="True" 
                                Text='<%# Eval("OSINTERESTCURRENT", Eval("DECPOINT")) %>' 
                                CssClass="style1"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="HeaderStyle">
                    ...
                    <tr>
                        ...
                        <td >
                            <asp:Label ID="Label37" runat="server" Font-Underline="True" 
                                Text='<%# Eval("PENALTYRATE") %>' CssClass="style1"></asp:Label></td>
                        <td >
                    ...
                    <tr>
                        ...
                        <td >
                            <asp:Label ID="Label38" runat="server" Font-Underline="True" 
                                Text='<%# Eval("WORKINGDAYS") %>' CssClass="style1"></asp:Label>
                            day(s)/week</td>
                        <td >
                            Grace Period</td>
                        <td >
                    ...
                    <tr>
                        ...
                        <td >
                            (<asp:Label ID="Label42" runat="server" Font-Underline="True" 
                                Text='<%# Eval("PAYMENTTYPE") %>' CssClass="style1"></asp:Label>)
                            <asp:Label ID="Label43" runat="server" Font-Underline="True" 
                                Text='<%# Eval("PAYMENTTYPENAME") %>' style="font-weight: 700"></asp:Label>
                        </td>
                        <td >
                            Early Payment</td>
                        <td >
