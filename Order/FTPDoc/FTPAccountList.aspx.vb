...
Partial Class FTPDoc_FTPAccountList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            'Dim strIsUserBranch As String = "0"
    ...
    Private Sub DataSearch()
        ...
        If Not IsPostBack() Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND (APPLICATION.LOCID=0 AND APPLICATION.APPID=0)"
        End If
        ...
        If Len(Trim(ddlStatus.SelectedValue)) > 0 Then
            If ddlStatus.SelectedValue = "X" Then
                Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND APPLICATION.APPSTATUS<>0"
            Else
                Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND APPLICATION.APPSTATUS=" & ddlStatus.SelectedValue
            End If
        End If
        If Len(Trim(ddlAppState.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND APPLICATION.APPSTATE=" & ddlAppState.SelectedValue
        End If

        If Len(Trim(ddlCustType.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND CUSTOMER.CUSTTYPE=" & ddlCustType.SelectedValue
        End If
        If Len(Trim(ddlAppType.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND APPLICATION.APPTYPE=" & ddlAppType.SelectedValue
        End If
        If Len(Trim(ddlSaleSource.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND APPLICATION.SALESOURCE=" & ddlSaleSource.SelectedValue
        End If
    ...
    Protected Sub gvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvData.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            If DataBinder.Eval(e.Row.DataItem, "APPSTATUS") = 0 Then
                e.Row.ForeColor = Drawing.Color.Red
            ElseIf DataBinder.Eval(e.Row.DataItem, "APPSTATUS") = 10 Then
