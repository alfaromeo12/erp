...
Partial Class MXPage
            ...
            If Len(Trim(strMenuID)) > 0 Then
                ...
                If oSDR.Read() Then
                    If oSDR("APPDATE").ToString() <> Date.Today() Then
                        ...
                        txtAppDate.Text = String.Format("{0:dd MMM yyyy}", oSDR("APPDATE"))
                        txtCompDate.Text = String.Format("{0:dd MMM yyyy}", Date.Today())
                    End If
    ...
    'Public Function FormatDateX(ByVal strDate As String) As Nullable(Of Date)
    '    If strDate = String.Empty Or strDate Is Nothing Or Len(Trim(strDate)) <= 0 Then
    '        FormatDateX = "01/01/1900"
    '    Else
    '        Dim m, d, y As String
