...
Partial Class DataUpload_UploadMF
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        ...
        'UploadFile(FileBranch, lblMessageBranch, "JFBRANCHUPLOAD", "FILE BRANCH")
        'UploadFile(FileInsurance, lblMessageInsurance, "JFINSURANCEUPLOAD", "FILE INSURANCE COMPANY")
        UploadFile(FileCustomer, lblMessageCustomer, "ACCUPLOAD", "FILE CUSTOMER")
        UploadFile(FileLoan, lblMessageLoan, "LOANUPLOAD", "FILE LOAN DATA")
        UploadFile(FileCollateral, lblMessageCollateral, "COLLUPLOAD", "FILE COLLATERAL")
        If pnlInstallment.Visible = True Then
            UploadFile(FileInstallment, lblMessageInstallment, "INSTALLMENTUPLOAD", "FILE INSTALLMENT")
        End If
    ...
    Private Sub UploadFile(ByVal oFileUpload As FileUpload, _
        ...
        If Not oFileUpload.PostedFile Is Nothing And oFileUpload.PostedFile.ContentLength > 0 Then
            ...
            Try
                ...
                strTableName = "MOSTempUpload_" & Request.Cookies("UID").Value
            ...
            Catch Exc As Exception
                ...
                oLabelMessage.Text = "UPLOAD DATA ERROR : " + strFileDesc + ": " & Exc.Message
