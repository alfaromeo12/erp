<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="UploadET.aspx.vb" Inherits="DataUpload_UploadET" title="ET UPLOAD" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                <asp:Panel ID="pnlPayment" runat="server" Width="100%" GroupingText="FILE ET (EARLY TERMINATION)" CssClass="FooterStyle" Font-Bold="True">
                <asp:FileUpload ID="FileBranch" runat="server" CssClass="required" Width="100%" 
                        Font-Size="Medium" size="75" />
                <asp:Label ID="lblMessageET" runat="server" CssClass="ErrHighLight" Visible="False"></asp:Label></asp:Panel>
            </td>
        </tr>
        <tr>
            <td>
    ...
    function ShowAlert(){
        alert("UPLOAD ET(Eearly Termination) File ERROR...! Please see the error detail..!");
    }
    </script>
    <%=strScript%>
