...
Partial Class Txn_AccUnRelease
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            For Each row As GridViewRow In gvData.Rows
                ...
                If oCheckBox IsNot Nothing Then
                    If oCheckBox.Checked Then
                        ...
                        lngRetVal = objDB.ExecSPReturnInteger("ACCOUNTUnReleaseSave",
                                objDB.MP("@LOCID", Data.SqlDbType.Int, strLOCID),
                                objDB.MP("@ACCID", Data.SqlDbType.BigInt, strACCID),
                                objDB.MP("@USERID", Data.SqlDbType.Int, Request.Cookies("UID").Value, 10, Data.ParameterDirection.Input)
                            )
                        If lngRetVal = -1 Then
                            lblMessage.Visible = True
                            lblMessage.Text = "ACCOUNT NOT YET RELEASED...!<BR>PLEASE CHECK IN ACCOUNT INQUIRY...!"
                        ElseIf lngRetVal = -2 Then
                            lblMessage.Visible = True
                            lblMessage.Text = "ACCOUNT ALREADY UN-RELEASED...!<BR>PLEASE CHECK IN ACCOUNT INQUIRY...!"
                        End If
            ...
            If Len(Trim(lblMessage.Text)) <= 0 Then
                lblMessage.Visible = True
                lblMessage.Text = "SAVE UN-RELEASED ACCOUNT COMPLETED...!"
            End If
            DataSearch()
        Catch ex As Exception
            lblMessage.Visible = True
            lblMessage.Text = "ERROR UN-RELEASE ACCOUNT: " & ex.Message & "<BR>PLEASE CHECK DETAIL ERROR MESSAGE..!"
        Finally
            objDB.Close()
            objDB = Nothing
        End Try
