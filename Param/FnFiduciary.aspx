<%@ Page Title="Param FN - Fiducia Fee" Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="FnFiduciary.aspx.vb" EnableEventValidation="false" Inherits="Param_FnFiduciary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
        ...
        <asp:Panel ID="pnlShow" runat="server" CssClass="ShowDetail">
            ...
            <asp:HiddenField ID="hidFnFiduciaryID" runat="server" /> 
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr class="FooterStyle" >
                            <td style="width: 115px">
                                <asp:Button
                                    ID="btnFunctionSearch" runat="server" Text="Search" CssClass="Search" ValidationGroup="ValSearch" />
                            </td>
                            <td>
            ...
            SelectCommand="SELECT NULL AS CODE, NULL AS NAME UNION ALL SELECT CODE, NAME FROM PARAMGLOBAL WITH (NOLOCK) WHERE (TYPE = 'OPERATOR')">
                ...
                <asp:SqlDataSource ID="sdsFiduciary" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
                    SelectCommand="SELECT DEALERID,AREAID,PRODUCTID, FIDUCIAID, TENOROPR1, TENORFROM, TENOROPR2, TENORTO, PRINCIPALOPR1, 
                                        PRINCIPALFROM, PRINCIPALOPR2, PRINCIPALTO, FIDUCIAFEE, REMARK FROM FNFIDUCIA WITH(NOLOCK)
                                        WHERE DELETESTS=0" 
            UpdateCommand="FNFIDUCIARYupdate" UpdateCommandType="StoredProcedure" 
            DeleteCommand="UPDATE FNFIDUCIA SET DELETESTS=1, LASTUPDATE=GETDATE(), LASTUSERID=@USERID WHERE FIDUCIAID=@FIDUCIAID">
                    <DeleteParameters>
                        <asp:CookieParameter CookieName="UID" Name="USERID" />
                        <asp:ControlParameter ControlID="gvData" Name="FIDUCIAID" 
                            PropertyName="SelectedValue" />
                    </DeleteParameters>
                    <UpdateParameters>
                        <asp:ControlParameter ControlID="hidFnFiduciaryID" Name="FIDUCIAID" 
                        ...
                        <asp:Parameter Name="FIDUCIAFEE" Type="Decimal" />
        ...
        <br />
               <asp:GridView ID="gvData" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        BorderWidth="1px"  Caption="Fiduciary List" DataKeyNames="FIDUCIAID" 
                          OnRowCreated="gvData_RowCreated"  OnRowCancelingEdit="gvData_RowCancelingEdit" 
                            OnRowEditing="gvData_RowEditing"
                    Width="99%" DataSourceID="sdsFiduciary" >
                        <Columns>
                                <asp:TemplateField Visible="False">
                                <ItemTemplate>
                                    <asp:label ID="lblFiduciaIdKey" runat="server" Visible="false" 
                                                Text='<% #DataBinder.Eval(Container.DataItem,"FIDUCIAID") %>' />
                                    </ItemTemplate>
                            </asp:TemplateField>
                              ...
                              <asp:TemplateField HeaderText="EDT" ShowHeader="False" > 
                                ...
                                <EditItemTemplate > 
                                    <asp:ImageButton ID="btnSave" style="cursor:pointer" runat="server" ImageUrl="~/Images/Save.gif" CommandName="Update" Text="Update"></asp:ImageButton> 
                            ...
                            <asp:TemplateField > 
                             ...
                             <asp:TemplateField HeaderText="TO">
                               ...
                               <asp:TemplateField >
                                <Itemstyle  HorizontalAlign="Right"/>
                                <ItemTemplate> 
                                    <asp:Label ID="lblFiduciaFee" runat="server" style="text-align:right" Text='<%# Eval("FIDUCIAFEE","{0:n}") %>' ></asp:Label> 
                                </ItemTemplate>                                        
                                <EditItemTemplate> 
                                    <asp:TextBox ID="txtFiduciaFee" runat="server" style="text-align:right" 
                                        Text='<%# Bind("FIDUCIAFEE", "{0:n}") %>' CssClass="required" ></asp:TextBox> 
                                    <asp:RequiredFieldValidator ID="reqFiduciaFee" runat="server" 
						                ControlToValidate="txtFiduciaFee" Display="None" 
						                ErrorMessage="Fiducia FEE must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
					                <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCEFiduciaFee" runat="server" 
						                HighlightCssClass="ErrHighLight" TargetControlID="reqFiduciaFee">
					                </ajaxToolkit:ValidatorCalloutExtender>
                                </EditItemTemplate> 
                                <FooterStyle  HorizontalAlign="Right"/>
                                <FooterTemplate> 
                                    <asp:TextBox ID="txtNewFiduciaFee" runat="server" style="text-align:right" Text='<%# Eval("FIDUCIAFEE","{0:n}")%>' ></asp:TextBox> 
                                     <asp:RequiredFieldValidator ID="reqNewFiduciaFee" runat="server" 
						                ControlToValidate="txtNewFiduciaFee" Display="None" 
						                ErrorMessage="Fiducia FEE must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
					                <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCENewFiduciaFee" runat="server" 
						                HighlightCssClass="ErrHighLight" TargetControlID="reqNewFiduciaFee">
					                </ajaxToolkit:ValidatorCalloutExtender>
                                </FooterTemplate> 
                            </asp:TemplateField  >
                               <asp:TemplateField > 
