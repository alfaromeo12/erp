...
Partial Class Account_AccRSJFBatchApp
    ...
    Protected Sub btnApprove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApprove.Click
        ...
        Dim objDB As New DBX
        Try
            objDB.ExecSP("[RESCHEDULEApprovalPerJF]", _
            ...
            lblMessage.Text = "JF RESCHEDULE APPROVE BATCH SAVED COMPLETED...!"
            DataSearch()
        Catch ex As Exception
            lblMessage.Visible = True
            lblMessage.Text = "ERROR JF RESCHEDULE APPROVE BATCH: " & ex.Message & "<BR>PLEASE CHECK DETAIL ERROR MESSAGE..!"
        Finally
            objDB.Close()
            objDB = Nothing
    ...
    Protected Sub btnReject_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReject.Click
        ...
        Try
            ...
            lblMessage.Visible = True
            lblMessage.Text = "JF RESCHEDULE REJECT BATCH SAVED COMPLETED...!"
            DataSearch()
        Catch ex As Exception
            lblMessage.Visible = True
            lblMessage.Text = "ERROR JF RESCHEDULE REJECT BATCH: " & ex.Message & "<BR>PLEASE CHECK DETAIL ERROR MESSAGE..!"
        Finally
            objDB.Close()
            objDB = Nothing
