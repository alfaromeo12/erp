...
Partial Class DataUpload_UploadET
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        UploadFile(FileBranch, lblMessageET, "ETUPLOAD", "FILE ET (EARLY TERMINATION)")
    ...
    Private Sub UploadFile(ByVal oFileUpload As FileUpload, _
        ...
        If Not oFileUpload.PostedFile Is Nothing And oFileUpload.PostedFile.ContentLength > 0 Then
            ...
            Try
                ...
                strTableName = "MOSTempETUpload_" & Request.Cookies("UID").Value
            ...
            Catch Exc As Exception
                ...
                oLabelMessage.Text = "UPLOAD ET(EARLY TERMINATION) ERROR : " + strFileDesc + ": " & Exc.Message
