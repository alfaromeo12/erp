...
Partial Class Txn_RSBatch
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim objDB As New DBX
        Try
            objDB.ExecSP("RESCHEDULEAddPerBranch", _
            ...
            lblMessage.Text = "RESCHEDULE INPUT BATCH SAVED COMPLETED...!"
            DataSearch()
        Catch ex As Exception
            lblMessage.Visible = True
            lblMessage.Text = "ERROR RESCHEDULE INPUT BATCH: " & ex.Message & "<BR>PLEASE CHECK DETAIL ERROR MESSAGE...!"
        Finally
            objDB.Close()
            objDB = Nothing
