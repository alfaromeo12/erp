...
Partial Class Txn_AccWO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack() Then
            ...
            SetObjectValidation(txtDPDFrom, True, "integer", "[0-9]")
            SetObjectValidation(txtDPDTo, True, "integer", "[0-9]")
    ...
    Private Sub DataSearch()
        ...
        If rbDPDFrom.Checked Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND EXISTS (SELECT 'X' FROM INSTALLMENT WITH(NOLOCK) WHERE ACCOUNT.LOCID=INSTALLMENT.LOCID AND ACCOUNT.ACCID=INSTALLMENT.ACCID " & _
                " AND PAIDSTS=0 HAVING DATEDIFF(DAY, MIN(DUEDATE), dbo.f_getAppDate()) BETWEEN " & txtDPDFrom.Text & " AND " & txtDPDTo.Text & " )"
        End If
        ...
        If Len(Trim(ddlCollectibilityInt.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNT.COLLECTIDINT=" & ddlCollectibilityInt.SelectedValue
        End If
