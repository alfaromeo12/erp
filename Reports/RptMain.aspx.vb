...
Partial Class Reports_RptMain
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("Action") = "Report" Then
            ...
            Dim strExport As String = ddlExport.SelectedValue
            ...
            Try
                ...
                End If
                strURL = strReportName & "&rs:Command=Render&rc:Parameters=false&rc:DocMap=true" & strParam & "&EXPORT=" & strExport
    ...
    Public Sub SetInputParam()
        ...
        Dim oAjaxMaskDate As AjaxControlToolkit.MaskedEditExtender
        Dim strURL As String = ""
            ...
            Try
                ...
                While oSDR.Read
                    ...
                    If oSDR("FieldInputType").ToString = "2" Then 'combobox
                        ...
                        'SetObjectValidation(oDropDown, False)
                    ...
                    Else 'textbox
                        ...
                        'SetObjectValidation(oTextBox, False, strValidation, strFilter)
                        ...
                        If oSDR("FieldDataType") = "3" Then  'date
                            ...
                            oAjaxMaskDate = New AjaxControlToolkit.MaskedEditExtender
                            oAjaxMaskDate.ID = "ajaxMEEDate" & oSDR("FieldName").ToString
                            oAjaxMaskDate.TargetControlID = oTextBox.ID
                            oAjaxMaskDate.MaskType = AjaxControlToolkit.MaskedEditType.Date
                            oAjaxMaskDate.Mask = "99/99/9999"
                            pnlParamDetail.Controls.Add(oAjaxMaskDate)
                        End If
                    End If
