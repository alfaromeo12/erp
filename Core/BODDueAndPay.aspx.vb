...
Partial Class AppSetting_BODDueAndPay
    ...
    Protected Sub btnProcess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcess.Click
        ...
        Try
            ...
            objCore.BODGenerateDueAndPayment(ConvertDate(txtAppDate.Text), Request.Cookies("UID").Value)
            DataSearch()
            lblMessage.Text = "MESSAGE : PROCESS COMPLETED...!"
        Catch ex As Exception
            lblMessage.Text = "ERROR BOD Generate Due and Payment...!PLEASE CHECK DETAIL ERROR MESSAGE : " & ex.Message
            lblMessage.Focus()
            'Throw
        Finally
            objCore = Nothing
