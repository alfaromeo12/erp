Partial Class Account_AccPPAPEntry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        SetObjectValidation(txtPPAP, False, "float", "[0-9.]")
        If Not IsPostBack() Then
            ...
            Try
                ...
                If oSDR.Read() Then
                    If Not String.IsNullOrEmpty(oSDR("PPAPValue").ToString()) Then
                        txtPPAP.Text = String.Format("{0:N}", oSDR("PPAPValue"))
                    Else
                        txtPPAP.Text = "0"
                    End If
                End If
            ...
            Catch ex As Exception
                ...
                lblMessage.Text = "ERROR LOADING ENTRY PPAP: " & ex.Message & "<BR>PLEASE CHECK DETAIL ERROR MESSAGE...!"
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            lblMessage.Visible = True
            lblMessage.Text = "SAVE ENTRY PPAP COMPLETED...!"
        Catch ex As Exception
            lblMessage.Visible = True
            lblMessage.Text = "ERROR SAVE ENTRY PPAP: " & ex.Message & "<BR>PLEASE CHECK DETAIL ERROR MESSAGE...!"
        Finally
            objDB.Close()
            objDB = Nothing
