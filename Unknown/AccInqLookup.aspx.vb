...
Partial Class Unknown_AccInqLookup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            oSDR = objDB.CreateSDRFromSQLSelect("SELECT APPVALUE,dbo.f_getAppSetting('PAYHANDLEBRANCEONLY')PAYHANDLEBRANCEONLY, CAST(dbo.f_IsUserBranch(" & Request.Cookies("UID").Value & ") as VARCHAR(10)) ISUSERBRANCH FROM APPSETTING WITH(NOLOCK) WHERE APPCODE='APPDATE'")
            If oSDR.Read Then
            ...
            'hanya untuk default saja, boleh pilih account cabang lain
