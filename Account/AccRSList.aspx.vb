Partial Class Txn_AccRS
    ...
    Private Sub DataSearch()
        ...
        If Len(Trim(ddlInstallmentType.SelectedValue)) > 0 Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNT.INSTALLMENTTYPE=" & ddlInstallmentType.SelectedValue
        End If
        ...
        'If Not IsPostBack Then
        '    Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND ACCOUNT.ACCSTATUS<>0"
        'End If
        gvData.DataBind()
    End Sub
