<%@ Page Language="VB" MasterPageFile="~/MXPage.master" AutoEventWireup="false" CodeFile="CollectStsApp.aspx.vb" Inherits="Param_Collect" title="Collect Status" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <asp:DropDownList ID="ddlCriteria" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlCollectCatSearch" runat="server" AutoPostBack="True" DataSourceID="sdsCollectCatSearch"
    ...
    <asp:Panel ID="pnlData" runat="server">
        <asp:GridView ID="gvData" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            DataKeyNames="COLLECTID" Caption="Collectibility Status Approval List" 
            RowHeaderColumn="COLLECTID">
            <Columns>
    ...
    <asp:SqlDataSource ID="sdsGrid" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        ...
        SelectCommand="SELECT COLLECTID, COLLECTNAME, 'X' + FROMOPR + CAST(FROMDPD AS VARCHAR(20)) AS CONDITION1, 'X' + TOOPR + CAST(TODPD AS VARCHAR(20)) AS CONDITION2, REMARK, COLLECTCODE, RESERVED, COLLATERALPERCENTAGE FROM COLLECTSTSX WHERE (COLLECTCAT = @COLLECTCAT)">
        <SelectParameters>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ID</td>
                        <td>
                            <asp:Label ID="COLLECTIDLabel1" runat="server" Font-Bold="True" 
                                Font-Underline="True" Text='<%# Eval("COLLECTID") %>'></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            Collect Code</td>
                        <td>
                            <asp:TextBox ID="txtCollectCode" runat="server" CssClass="required" 
                                MaxLength="5" Text='<%# Bind("COLLECTCODE") %>' Width="54px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqCollectCode" runat="server" 
                                ControlToValidate="txtCollectCode" Display="None" 
                                ErrorMessage="COLLECT CODE must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCECollectCode" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqCollectCode">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCollectCat" runat="server" CssClass="required" 
                                DataSourceID="sdsCollectCat" DataTextField="NAME" DataValueField="CODE" 
                                SelectedValue='<%# Bind("COLLECTCAT") %>'>
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqCollectCat" runat="server" 
                                ControlToValidate="ddlCollectCat" Display="None" 
                                ErrorMessage="COLLECT CATEGORY must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCECollectCat" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqCollectCat">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCollectName" runat="server" CssClass="required" 
                                MaxLength="50" Text='<%# Bind("COLLECTNAME") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqCollectName" runat="server" 
                                ControlToValidate="txtCollectName" Display="None" 
                                ErrorMessage="COLLECT NAME must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCECollectName" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqCollectName">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            X
                            <asp:DropDownList ID="ddlOPRFrom" runat="server" CssClass="required" 
                                DataSourceID="sdsOPR" DataTextField="NAME" DataValueField="CODE" 
                                SelectedValue='<%# Bind("FROMOPR") %>'>
                            </asp:DropDownList>
                            <asp:TextBox ID="txtDPDFrom" runat="server" CssClass="required" 
                                Style="text-align: right" Text='<%# Bind("FROMDPD") %>' Width="64px"></asp:TextBox>
                            day(s)<asp:RequiredFieldValidator ID="reqDPDFrom" runat="server" 
                                ControlToValidate="txtDPDFrom" Display="None" 
                                ErrorMessage="DPD FROM must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCEDPDFrom" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqDPDFrom">
                            </ajaxToolkit:ValidatorCalloutExtender>
                            <asp:RequiredFieldValidator ID="reqOPRFrom" runat="server" 
                                ControlToValidate="ddlOPRFrom" Display="None" 
                                ErrorMessage="OPERATOR FROM must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCEOPRFrom" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqOPRFrom">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            X
                            <asp:DropDownList ID="ddlOPRTo" runat="server" CssClass="required" 
                                DataSourceID="sdsOPR" DataTextField="NAME" DataValueField="CODE" 
                                SelectedValue='<%# Bind("TOOPR") %>'>
                            </asp:DropDownList>
                            <asp:TextBox ID="txtDPDTo" runat="server" CssClass="required" 
                                Style="text-align: right" Text='<%# Bind("TODPD") %>' Width="64px"></asp:TextBox>
                            day(s)<asp:RequiredFieldValidator ID="reqDPDTo" runat="server" 
                                ControlToValidate="txtDPDTo" Display="None" 
                                ErrorMessage="DPD TO must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCEDPDTo" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqDPDTo">
                            </ajaxToolkit:ValidatorCalloutExtender>
                            <asp:RequiredFieldValidator ID="reqOPRTo" runat="server" 
                                ControlToValidate="ddlOPRTo" Display="None" 
                                ErrorMessage="OPERATOR TO must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCEOPRTo" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqOPRTo">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 22px">
                            Remark</td>
                        <td style="height: 22px">
                            <asp:TextBox ID="REMARKTextBox" runat="server" MaxLength="100" 
                                Text='<%# Bind("REMARK") %>' Width="248px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtCollateralPercent" runat="server" CssClass="required" 
                                Style="text-align: right" Text='<%# Bind("COLLATERALPERCENTAGE") %>' 
                                Width="48px"></asp:TextBox>
                            %<asp:RequiredFieldValidator ID="reqCollateralPercent" runat="server" 
                                ControlToValidate="txtCollateralPercent" Display="None" 
                                ErrorMessage="COLLATERAL PERCENTAGE must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCECollateralPercentage" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqCollateralPercent">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            Reserved</td>
                        <td>
                            <asp:TextBox ID="txtReserved" runat="server" CssClass="required" 
                                Style="text-align: right" Text='<%# Bind("RESERVED") %>' Width="48px"></asp:TextBox>
                            %<asp:RequiredFieldValidator ID="reqReserved" runat="server" 
                                ControlToValidate="txtReserved" Display="None" 
                                ErrorMessage="RESERVED must be entry...!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="ajaxVCEReserved" runat="server" 
                                HighlightCssClass="ErrHighLight" TargetControlID="reqReserved">
                            </ajaxToolkit:ValidatorCalloutExtender>
                        </td>
                    </tr>                   
                </table>
    ...
    <asp:SqlDataSource ID="sdsForm" runat="server" ConnectionString="<%$ ConnectionStrings:connection %>"
        ...
        SelectCommand="SELECT COLLECTID, COLLECTCAT, COLLECTNAME, FROMDPD, FROMOPR, TODPD, TOOPR, REMARK, COLLECTCODE, RESERVED, COLLATERALPERCENTAGE FROM COLLECTSTSX WHERE (COLLECTID = @COLLECTID)" 
