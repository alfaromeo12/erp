...
Partial Class DataUpload_UploadCOLL
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        UploadFile(FileBranch, lblMessageColl, "BPKBUPLOAD", "FILE COLLATERAL")
    ...
    Private Sub UploadFile(ByVal oFileUpload As FileUpload, _
        ...
        Catch ex As Exception
            ...
            oLabelMessage.Text = "ERROR UPLOAD : " & ex.Message
        Finally
            objDB.Close()
            objDB = Nothing
        End Try
        ...
        If Not oFileUpload.PostedFile Is Nothing And oFileUpload.PostedFile.ContentLength > 0 Then
            ...
            Try
                ...
                strTableName = "MOSTempCollUpload_" & Request.Cookies("UID").Value
            ...
            Catch Exc As Exception
                oLabelMessage.CssClass = "ErrHighLight"
                oLabelMessage.Text = "ERROR UPLOAD COLLATERAL : " + strFileDesc + ": " & Exc.Message
