...
Partial Class ParamWarehouse_FirstStock
    ...
    Private Sub SetValidation()
        ...
        oTextBox = CType(fvData.FindControl("txtStockCode"), TextBox)
    ...
    Private Sub DataSearch()
        If Not IsPostBack() Then
            Me.sdsGrid.SelectCommand = Me.sdsGrid.SelectCommand & " AND FIRSTSTOCKID=-999"
        End If
    ...
    Protected Sub sdsForm_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles sdsForm.Inserted
        If e.Command.Parameters("@retval").Value = -1 Then
            ...
            lblError.Text = "Stock Code : " & e.Command.Parameters("@FIRSTSTOCKCODE").Value & " already exists..!"
        Else
            lblError.Visible = False
            fvData.Caption = ""
        End If
